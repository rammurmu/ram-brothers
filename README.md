...
In the few years `Since 2007`,`Ram Murmu` started offline retail store in `Bokaro Industrial Area`,Biada Street,Village Manjhladih North Gorabali Post Balidih PS Balidih City Bokaro Steel City Distric `Bokaro` State `Jharkhand` Country `India` Pin Code 827014
...
**The Business Journey is just beginning**
>
